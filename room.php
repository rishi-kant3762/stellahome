...
<!-- Mirrored from templates.hibootstrap.com/atoli/default/room.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Dec 2025 11:26:24 GMT -->
...
<head>
    ...
    <title>Atoli - Hotel & Resorts Booking Bootstrap 5 Template</title>
</head>
                    ...
                    <div class="header-right">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#89e1ece5e5e6c9e8fde6e5e0a7eae6e4"><span class="__cf_email__" data-cfemail="5a323f3636351a3b2e35363374393537">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="room.html" class="nav-link active">
                                            Rooms
                                        </a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <li class="nav-item-btn ">
                                <a href="book.html" class="default-btn btn-bg-one border-radius-5">Book Now</a>
                            </li>
                        </ul>

                        <div class="nav-btn">
                            <a href="book.html" class="default-btn btn-bg-three">Book Now</a>
                        </div>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <ul class="footer-list-contact">
                                ...
                                <li>
                                    <i class='bx bx-envelope'></i>
                                    <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#c1a9a4adadae81a0b5aeada8efa2aeac"><span class="__cf_email__" data-cfemail="a7cfc2cbcbc8e7c6d3c8cbce89c4c8ca">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-8">
                        <div class="copy-right-text text-align1">
                            <p>© <span>Atoli</span> is Proudly Owned by <a href="https://hibootstrap.com/" target="_blank">HiBoostrap</a></p>
                        </div>
                    </div>
